class GameQuestion():
	def __init__(self, text, correct_answer, question_subject, question_type, game_id, game_title, game_location, game_date):
	...
	def __str__(self):
		return "{text} - {answer}".format(text=self.text, answer=repr(self.correct_answers))
